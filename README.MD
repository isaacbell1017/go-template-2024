...
You must configure your environment before running the app. To configure the app as a default development environment, run the following command to generate a `.env` file.
